...
### 2.2 瓦贝链针对痛点设计理念 
   ...
   瓦贝链的针对痛点也是其核心价值有三点：1）实业项目产品数字化，借区块链实现资产流动性；2）项目利用区块链数字化预售融资，解决实体企业长期困扰的发展融资问题；3）消费回报，即设法让瓦贝持有人获得项目方长期利润回报，介于数字资产的高流动性特点，对贝持有人的具体回报操作见下述第三章第2项。 
...
### 2.5 技术创新及瓦贝增值策略
   ...
   瓦贝池指的是预制到瓦贝链的2000万个瓦贝数字资产和矿工挖矿所得的瓦贝数字资产总和，矿工每年挖矿总额不超过500万个，后期经矿工大会讨论可减半生产或逐渐停产，未来很可能一贝难求，建议上限4000万个，可无限分割。
