...
#### <div align=center><img src="./images/logo.png" width = "256" height = "59" ></div>
...
## 前言 
   在霸权与垄断资本笼罩的地球上，人类为了物质利益的争夺，由古至今，用强权与垄断资本控制资源、获得劳动人民剩余价值似乎成为永恒不变的主题，我们要用技术的力量打破这种不公平，回到人类发展的俩个基点，实现反向平衡，使大众可以用消费去引导生产，让大众消费获的长期回报，由此产生消费为项目融资，项目为消费提供产品及投资回报的商业模式，同时实现大量闲置资产的二次流通利用，而这一共享经济模式要依赖于与去中心化技术的实现——区块链技术。愿我们的努力能让世界更加祥和安宁、大众生活更加美满幸福！

## 一、项目摘要

   瓦贝链是共享经济区块链化的表现形式，平台整合社会闲置资产资源产品，合理优化后为社会共享使用，达到物品尽其用，最大回馈社会的目的。瓦贝链的突出贡献在于使社会闲置资源得到流通和再利用，解决社会资源闲置和流动性枯竭问题，瓦贝链是以区块链技术为核心技术支撑，从技术角度看，将实体闲置资产资源产品甚至是服务产品数字化，促进其价值流动和二次利用，最有效措施是使用区块链技术。区块链技术也被称为价值互联网技术，而瓦贝链是价值互联网在共享经济领域的实现形式之一。
...
### 2.5 技术创新
   ...
   瓦贝链的技术创新核心在于商业模式设计创新。瓦贝池代表实物池进行交易和流通，实物池的生产力不断补充和提升链码池的价值，因此未来瓦贝链的核心数字资产瓦贝价值将不断提升，从而区别于空气币类的数字资产。
    
## 三、 瓦贝链的应用实施方案
### 3.1 挖矿共识算法ethash 
   挖矿这个词源于对加密货币与黄金的类比。黄金或贵金属很稀有，电子代币也是，增加总量的唯一方法就是挖矿。瓦贝网络也是这样，发行的唯一办法就是挖矿。但是不像其他例子，挖矿也是通过在区块链中创建、验证、发行和传播区块来保护网络的方法。瓦贝链是以太坊开发网络的成员之一，与全世界上万个程序工作组一样，共同维护着以太坊网络，而维护网络的通行办法是：挖瓦贝=保护网络=验证计算=记账，挖矿也是瓦贝区块链共享云计算的实现方式。
   #### 3.1.1什么是挖矿
...
### 3.2 项目应用落地
   #### 3.2.1 实物产品选择
   瓦贝链以共享房屋为核心，所有的瓦贝持有人权益最终落点在共享房屋，因此瓦贝链将在全国各地风景优美的地点选择在建酒店或酒店式公寓项目的租赁后放入实物池，瓦贝链将逐步以类似方式将共享能源、共享旅游等产品放入实物池。目前与瓦贝链达成合作意向的房屋20万平米。首次发行将基于这些房屋租赁使用权产品进行，每批发售产品的方式将根据产品特点制定略有不同的销售和回报方案，详情见：https://github.com/wabei/announcement ,可通过哈希值查询链上公告承诺。
   #### 3.2.2 产品选择及对提供商的要求
   必须是可产生持续经济来源的项目，项目一旦与瓦贝链合作将全面被瓦贝链形式托管，管理权由瓦贝链发起人指定，提供商具备管理能力的将最低收取项目管理收益的40%作为回报负责管理具体项目，瓦贝链发起人：中国内蒙古巨著公司将持有剩余管理回报，管理回报不超过项目总收益的50%。提供商较为适合初创优质项目、成品地产项目、成熟拟整体出让的旅游、路桥、矿产项目等等，简而言之，提供商通过瓦贝链出售产品获得持续生产建设资金，最终搭建完备可持续利润提供的项目，并在获得资金后履行将不低于50%的项目收益打入公益池。
   #### 3.2.3 发售
   瓦贝链采用实物产品销售众筹的方式，发售瓦贝，每批次发售都对应一定数额的实物或服务产品，分批发售完创始团队持有的2000个瓦贝，瓦贝是这些产品权益的持有凭证，是典型的实物代表数字资产。瓦贝的持有者根据贝的持有份额动态享有实物池的产品权益,计算公式如下：
![image3.2](./images/3-2.jpg "图3-2 AMOP架构")
   #### 3.2.4 瓦贝持有人权益使用
  按日动态享有每个瓦贝的居住面积使用权，地域不限，瓦贝链旗下的共享房屋将位于世界各地，入住共享房屋需质押贝持有人的瓦贝，避免当日重复使用；贝持有人于酒店中的免费项目来源于实物池当日可支持均值除以365天，举例，流通中的总瓦贝数为1万，实物池中可消费总值为36500万美金，那么每个贝的于共享房屋中的可免费消费额=36500万/1万/365天×3=30美金，之所以3年拆分可消费总额是为贝的持有人转让后的其他持有人和全体持有人长期享有考虑，寅吃卯粮不可取。按日计算权益，享用几日质押几日，避免重复消费，简称：单贝日权益质押。      
               瓦贝持有人许可使用瓦贝在瓦贝链系统内消费、投资，价格随行就市。
![image3.3](./images/3-3.jpg "图3-3 AMOP架构")                                                                                                           
### 3.3 资源对接
共享房屋项目资源来自中国政府房产管理部门的直接引荐，可迅速对接全国地产商及其商业房产项目（住宅房产不属于瓦贝数字化范畴）；共享农业，中国有18亿亩尚未进入数字租赁流通市场，而中国创新和一代一路战略将为瓦贝链带来源源不断的优质项目。   
## 四、未来展望
### 4.1 钱包合约
   钱包与合约是瓦贝链的主要客户的，分为网页版和手机版俩种。主要功能查询、转账。钱包应用同时支持智能合约，瓦贝链的合约开发主要是围绕瓦贝链的管理、使用进行，举例未来对项目管理人进行优胜劣汰，瓦贝链条内部可以开发投票合约，为了瓦贝链的共享教育板块我们可以提供开发数学竞赛智能合约。
### 4.2  社区组织：   
...
## 五、核心团队成员介绍
   ### 张  海    
   1981年，中国内蒙古，内蒙古链上担保CEO，瓦贝链项目发起人，毕业于中国南开大学，金融人工智能开发者，仿生学量子计算机研究者，熟悉go、c++、mql4语言，从业14年；
   ### Tank    
   1987年 ，深圳，毕业于陕西理工大学，挖贝链发起人之一，精通android，Java，linux相关技术，从事人工智能，区块链等新技术研究，负责挖贝相关平台等技术研究与落地;
   ### 李徽翡    
   1977年，中国安徽，瓦贝链架构师，发起人之一，毕业于大连理工大学，精通JAVA，熟悉大型系统架构和加密技术，从业20年；
   ### 刘  召    
   1987年，中国内蒙古，内蒙古峻宇科技创始人，熟悉JAVA、PHP,从业15年，瓦贝链发起人之一;        
   ### ALEX     
   1977年 ，中国香港，资深律师，熟悉证券、法务，瓦贝链发行合伙人；
   ### SANDY    
...
-   源码地址：https://github.com/wabei/go-wabei
