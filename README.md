...
## 前言 
   在霸权与垄断资本笼罩的地球上，人类为了物质利益的争夺，从古至今，用强权和垄断资本去控制资源、获得人民劳动剩余价值似乎成为永恒不变的主题，我们要用技术的力量打破这种不公平，回到人类发展的俩个基点，实现反向平衡，使民众可以用消费去引导生产，让民众消费获的长期回报，由此产生消费为项目融资，项目为消费提供产品及投资回报的商业模式，同时实现大量闲置资产的二次优化利用，而这一共享经济模式要依赖于与去中心化技术的实现——区块链技术。愿我们的努力能让世界更加平和、大众生活更加幸福！由此诞生——瓦贝共享公有区块链。
...
### 2.2 瓦贝链的设计理念 
   ...
   瓦贝链的核心价值有三点：1）实业项目产品数字化，借区块链实现资产流动性；2）项目利用区块链数字化预售融资，0负担解决企业发展融资问题；3）消费回报，即设法让流动中的币持有人获得项目方长期利润回报，介于数字资产的高流动性特点，对贝持有人的具体回报操作见下述第三章第2项。
...
## 三、 瓦贝链的应用实施方案
### 3.1 挖矿共识算法ethash 
   挖矿这个词源于对加密货币与黄金的类比。黄金或贵金属很稀有，电子代币也是，增加总量的唯一方法就是挖矿。瓦贝网络网络也是这样，发行的唯一办法就是挖矿。但是不像其他例子，挖矿也是通过在区块链中创建、验证、发行和传播区块来保护网络的方法。瓦贝链是以太坊开发网络的成员之一，与全世界上万个程序工作组一样，共同维护着以太坊网络，而维护网络的通行办法是：挖瓦贝=保护网络=验证计算=记账，挖矿也是瓦贝区块链共享云计算的实现方式。
   #### 3.1.1什么是挖矿
...
![image3.2](./images/3-2.jpg "图3-2 AMOP架构")
   #### 3.2.4 瓦贝持有人权益使用
  按日动态享有每个瓦贝的居住面积使用权，地域不限，瓦贝链旗下的共享房屋将位于世界各地，入住共享房屋需质押贝持有人的瓦贝，避免当日重复使用；贝持有人于酒店中的免费项目来源于实物池当日可支持均值除以365天，举例，流通中的总瓦贝数为1万，实物池中可消费总值为36500万美金，那么每个贝的于共享房屋中的可免费消费额=36500万/1万/365天=100美金，之所以365天拆分可消费总额是为贝的持有人长期享有考虑，寅吃卯粮不可取。         
